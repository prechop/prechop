      ...
      <Grid $min={300} $gap={16}>
        ...
        <Card>
          <Stack $gap={8}>
            ...
            />
            <Field label="Active sessions" value={user.activeSessions} />
            <Field
              label="Last login"
              value={
        ...
        <Card>
          <Stack $gap={8}>
            ...
            <Field label="Effective actions" value={access.actionCount} />
            <Field label="Direct policies" value={access.directPolicyCount} />
            <Stack $gap={4} style={{ marginTop: 6 }}>
              ...
              <div>
                {(access?.roles ?? []).length === 0 ? (
                  <Text $size={13}>No buyer/vendor/admin role</Text>
                ) : (
            ...
            <Stack $gap={4} style={{ marginTop: 6 }}>
              ...
              <div>
                {access.groups.length === 0 ? (
                  ...
                  access.groups.map((g) => <Pill key={g}>{g}</Pill>)
                )}
              </div>
            </Stack>
          </Stack>
        ...
        {vendor && (
          <Card>
            <Stack $gap={8}>
              ...
              <Field
                label="Status"
                value={<Badge $tone="muted">{vendor.status}</Badge>}
              />
              <Field
              ...
              />
              <Field label="Total orders" value={vendor.totalOrders} />
              <Field
          ...
          <Stack $gap={8}>
            ...
            {Object.keys(orders.byStatus).length === 0 ? (
              ...
              Object.entries(orders.byStatus).map(([s, n]) => (
                <Field key={s} label={statusLabel(s)} value={n} />
              ))
            )}
          </Stack>
        </Card>
            ...
            orders.recent.map((o) => (
              <ListRow key={o.id}>
                ...
                <Row $gap={10} $align="center">
                  <Badge $tone="muted">{statusLabel(o.status)}</Badge>
                  <Text $weight={700} $size={13}>
