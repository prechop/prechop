...
const CATEGORY_TABS: Array<{ value: CategoryFilterValue; label: string }> = [
	{ value: "ALL", label: "All" },
...
const CategoryRail = styled.nav`
  margin: var(--pc-space-1) 0 var(--pc-space-4);
  padding: 10px;
  border: 1px solid var(--pc-border);
  border-radius: var(--pc-radius-lg);
  background:
    linear-gradient(135deg, rgba(255, 106, 43, 0.1), rgba(244, 185, 66, 0.08)),
    var(--pc-surface);
