...
const VendorCard = styled(Card)`
  ...
  border-radius: 18px;
  background:
    linear-gradient(180deg, rgba(255, 255, 255, 0.025), rgba(255, 90, 31, 0.035)),
...
const MediaShade = styled.div`
  ...
  pointer-events: none;
  background:
    linear-gradient(to top, rgba(13, 9, 6, 0.44), rgba(13, 9, 6, 0.08) 38%, transparent 68%),
...
const MarketplaceSurface = styled(Stack)`
  ...
  &::before {
    ...
    pointer-events: none;
    background:
      radial-gradient(680px 420px at 88% 8%, rgba(255, 90, 31, 0.1), transparent 66%),
      radial-gradient(520px 320px at 12% 22%, rgba(244, 180, 0, 0.07), transparent 62%);
  }
`;
