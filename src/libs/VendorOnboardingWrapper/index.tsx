          ...
          <ProgressInner>
            <ProgressTop>
              <Stack $gap={2}>
                ...
                <ProgressPct>{vendor.profileCompleteness ?? 0}%</ProgressPct>
              </Stack>
              <ProgressLabel>
                ...
                <StepBody>
                  ...
                  {r.key === "categories" && (
                    <Stack $gap={12}>
                      ...
                      <Button $full $loading={busy} onClick={saveCategories}>
                        Save & continue
                      </Button>
                    </Stack>
                  )}
                      ...
                      {isPending ? (
                        ...
                        <Stack $gap={10}>
                          ...
                          <label
                            ...
                            />
                            I accept Prechop's 8% commission policy.
                          </label>
                        </Stack>
                      )}
                      <Button
