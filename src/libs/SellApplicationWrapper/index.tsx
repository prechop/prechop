					...
					<Shell>
						<Stack $gap={18}>
							...
							<Stack $gap={6} style={{ textAlign: "center" }}>
								...
								<Text $muted>
									You need one Prechop account for both buying
									and selling. Continue first, then we'll take
									you directly to the vendor application.
								</Text>
							</Stack>
							<Button
								$full
								...
								onClick={() =>
									router.push(
										isAuthenticated
											? "/vendor/settings"
											: "/login?next=/vendor/settings&intent=sell",
									)
								}
							>
								Continue to Prechop
