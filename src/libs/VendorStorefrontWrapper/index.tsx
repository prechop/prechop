...
const TimetableGrid = styled.div`
  ...
  gap: var(--pc-space-4);
`;
const TimetableCard = styled(Card)`
  display: flex;
	...
	return (
		<Wrap $gap={18}>
			<StorefrontSurface $gap={18}>
				...
				<Stack $gap={10} id="timetable">
					<SectionTop>
						<div>
							<SectionTitle>Weekly plan</SectionTitle>
							<SectionSub>
								What this kitchen plans to cook each day
							</SectionSub>
						</div>
					</SectionTop>
					{!timetable || timetable.length === 0 ? (
						<EmptyState
							...
							description="This kitchen has not published a weekly timetable."
						/>
					) : (
						<TimetableGrid>
