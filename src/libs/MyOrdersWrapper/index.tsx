...
export default function MyOrdersWrapper() {
  const { data, isLoading } = useSWR<BuyerOrder[]>("/orders?limit=50", fetcher);
          ...
          <FadeIn>
            <CompactStatsGrid>
              ...
              <StatCard
                ...
                hint={activeCount === 1 ? "1 cooking" : "cooking now"}
              />
              <StatCard
                label="Spent"
                  ...
                  <Stack $gap={12}>
                    <Row $justify="space-between" $align="flex-start" $gap={12}>
                      <Row $gap={12} $align="center">
                        ...
                        <Stack $gap={2}>
                          <Text $weight={800}>{o.orderNumber}</Text>
                          <Text $muted $size={13}>
                    ...
                    <Row $justify="space-between" $align="center" $gap={10}>
                      ...
                      <Row $gap={8} $align="center">
                        <Text $weight={800}>{formatKobo(o.totalKobo)}</Text>
