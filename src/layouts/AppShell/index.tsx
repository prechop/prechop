...
const Main = styled.main<{ $noSidebar?: boolean }>`
  ...
  @media (min-width: 760px) {
    ...
    padding-left: ${(p) => (p.$noSidebar ? 0 : "220px")};
      ...
      <Bar>
        <BarInner>
          <Brand href={isVendor ? "/dashboard" : "/marketplace"}>
            ...
            <Logo aria-hidden>
              <Image src="/dark.png" alt="Prechop" width={28} height={28} />
            </Logo>
            Prechop
          </Brand>
          {!isVendor && (
              ...
              {buyerNav.map((n) => {
                ...
                return (
                  <TopLink
                    ...
                    {n.label === "Alerts" && alertCount > 0 && !active ? (
                      <IconBadgeWrap aria-hidden>
                        <span>{n.icon}</span>
                        <TopBadge>{compactCount(alertCount)}</TopBadge>
                      </IconBadgeWrap>
                    ) : n.icon ? (
          ...
          <Right>
            ...
            {isAuthenticated ? (
              isVendor ? (
                ...
                <AccountMenu accountHref="/account" logout={logout} />
              )
            ) : (
