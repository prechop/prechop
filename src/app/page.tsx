...
const Plate = styled.div`
	...
	&::after {
		...
		position: absolute;
		inset: 0;
		background: radial-gradient(400px 300px at 30% 20%, rgba(255,255,255,0.35), transparent 60%);
	}
`;
const FloatCard = styled.div<{ $pos: string; $delay: number }>`
	...
	strong { font-size: 14px; font-weight: 800; letter-spacing: -0.02em; }
	small { font-size: 12px; color: var(--pc-text-muted); font-weight: 600; }
	.emoji {
		...
		<Page>
			...
			<Hero>
				<Copy>
					...
					<Lead>
						Browse today&apos;s campus kitchens, pay upfront, and
						pick up hot &mdash; no more sold-out disappointment.
						Vendors cook only to confirmed orders.
					</Lead>
					<CTAs>
				...
				<Visual aria-hidden>
					...
					<FloatCard $pos="bottom: 8%; right: -6%;" $delay={380}>
						<span
							className="emoji"
